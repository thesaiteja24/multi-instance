...
const TesterManagement = () => {
  ...
  useEffect(() => {
    ...
    setTesterCountryCode(
      countryList.find(c => c.value === '+91') || {
        value: '+91',
        label: '+91',
      }
    );
  ...
  const handleSave = async () => {
    ...
    if (!testerCountryCode) {
      Swal.fire({
        icon: 'error',
        title: 'Country code is missing.',
        text: 'Please select a valid country code.',
      });
      return;
    }
            ...
            {Array.isArray(currentItems) && currentItems.length > 0 ? (
              currentItems.map((item, idx) => (
                ...
                >
                  ...
                  <td className="px-6 py-3">{capitalize(item.location)}</td>
              ...
              <tr>
                <td colSpan="6" className="py-4 text-center text-[#535862]">
                  No testers found.
                </td>
              </tr>
            )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white rounded-[13px] w-[500px] p-[30px] flex flex-col gap-5 relative">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-[#00007F] font-medium text-[18px]">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <select
                  className="w-full h-[60px] px-[20px] pr-[40px] text-[#666666] text-[16px] font-normal leading-[24px] border border-[#00007F] rounded-[4px] appearance-none bg-white"
